...
import com.mikirinkode.firebasechatapp.databinding.ItemMessagePersonalBinding
import java.util.*
...
class PersonalConversationAdapter : RecyclerView.Adapter<PersonalConversationAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: ItemMessagePersonalBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ItemMessagePersonalBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    private fun setupDateHeader(
        binding: ItemMessagePersonalBinding,
        position: Int,
        context: Context
    ) {
        binding.apply {
