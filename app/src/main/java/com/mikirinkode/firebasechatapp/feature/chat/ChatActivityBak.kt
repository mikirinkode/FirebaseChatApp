...
import com.mikirinkode.firebasechatapp.databinding.ActivityChatBakBinding
...
class ChatActivityBak : AppCompatActivity(), ChatView, ChatAdapter.ChatClickListener {

    private val binding: ActivityChatBakBinding by lazy {
        ActivityChatBakBinding.inflate(layoutInflater)
    }
    ...
    private fun initView() {
        binding.apply {
            ...
            rvMessages.layoutManager = LinearLayoutManager(this@ChatActivityBak)
            rvMessages.adapter = chatAdapter
            chatAdapter.chatClickListener = this@ChatActivityBak
    ...
    private fun setupReceiverProfile(openedName: String?, openedAvatar: String?) {
        binding.apply {
            ...
            if (openedAvatar != null && openedAvatar != "") {
                Glide.with(this@ChatActivityBak)
                    .load(openedAvatar)
                    .into(ivUserAvatar)
            }
        }
    ...
    private fun onActionClicked() {
        binding.apply {
            ...
            btnSend.setOnClickListener {
                ...
                val imm =
                    this@ChatActivityBak.getSystemService(Context.INPUT_METHOD_SERVICE) as InputMethodManager
            ...
            btnCamera.setOnClickListener {
                if (PermissionManager.isCameraPermissionGranted(this@ChatActivityBak)) {
                    // Open Camera
                    presenter.takePicture()
                } else {
                    PermissionManager.requestCameraPermission(this@ChatActivityBak)
                }
            }

            btnImportFromGallery.setOnClickListener {
                if (PermissionManager.isReadExternalPermissionGranted(this@ChatActivityBak)) {

                } else {
                    PermissionManager.requestReadExternalPermission(this@ChatActivityBak)
                }
            }
